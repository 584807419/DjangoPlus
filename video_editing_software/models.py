...
#     OS = ((1,'mac OS'),(2,'Windows'))
#     name = models.CharField(default="", blank=True, null=True, max_length=50,verbose_name="软件名字")
#     size = models.IntegerField(default=0, blank=True, null=True, verbose_name="软件大小")
#     support_os = models.SmallIntegerField(default=2, choices=OS, blank=True, null=True, verbose_name="支持操作系统")
#     download_nums = models.IntegerField(default=0, verbose_name="下载量")
#     introduce =UEditorField(verbose_name="软件简介", width=600, height=300, imagePath="ueditor_img",
#                           filePath="ueditor_file",
#                           upload_settings={"imageMaxSize": 1204000},
#                           default="")
#     download_url = models.CharField(default="", blank=True, null=True, max_length=255,verbose_name="下载地址")
